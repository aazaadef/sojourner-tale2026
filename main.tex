...
% TODO before camera-ready: replace XXXXXXXXXXXXX with the ISBN EDAS shows for
% this paper. Portuguese university authors use the plain "IEEE" variant below;
% the Crown, European Union and U.S. Government variants do not apply.
\IEEEpubid{\makebox[\columnwidth]{%
  XXXXXXXXXXXXX/26/\$31.00~\copyright~2026 IEEE\hfill}%
